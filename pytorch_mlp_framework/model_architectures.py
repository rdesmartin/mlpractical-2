...
class BatchNormConvolutionalProcessingBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(BatchNormConvolutionalProcessingBlock, self).__init__()
    ...
    def build_module(self):
        ...
        # Add batch normalization 0
        self.layer_dict['bn_0'] = nn.BatchNorm2d(
        ...
        self.layer_dict['bn_1'] = nn.BatchNorm2d(
            num_features=out.shape[1]
        )
...
class BatchNormConvolutionalDimensionalityReductionBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(BatchNormConvolutionalDimensionalityReductionBlock, self).__init__()
...
#===================================================================================================
#                     Batch Normalization + Residual Connections Block                             #
#===================================================================================================
...
class BNRCConvolutionalProcessingBlock(nn.Module):
    ...
    def build_module(self):
        ...
        # the skip connections are applied from before the convolution layer
        x_rc = x
        ...
        # skip connection before the final activation function of the block
        out += x_rc
...
class BNRCConvolutionalDimensionalityReductionBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(BNRCConvolutionalDimensionalityReductionBlock, self).__init__()
